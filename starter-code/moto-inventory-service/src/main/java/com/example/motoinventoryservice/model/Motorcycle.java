...
public class Motorcycle {
    ...
    @Size(min = 1, max = 20, message = "VIN must be between 1 and 21 characters in length.")
    private String vin;
    @NotEmpty(message = "You must supply a value for make.")
    @Size(min = 1, max = 20, message = "Make must be between 1 and 21 characters in length.")
    private String make;
    @NotEmpty(message = "You must supply a value for model.")
    @Size(min = 1, max = 20, message = "Model must be between 1 and 21 characters in length.")
    ...
    @Size(min = 1, max = 20, message = "Color must be between 1 and 21 characters in length.")
