...
public class MotoInventoryController {
    ...
    public Map<String, String> getVehicle(@PathVariable String vin) {
        ...
        String vinLookupUri = serviceProtocol + instances.get(0).getHost() + ":" + instances.get(0).getPort() + servicePath;

        Map<String, String> vehicle = restTemplate.getForObject(vinLookupUri, HashMap.class, vin);
